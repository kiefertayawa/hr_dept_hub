...
export default function MemberInfo({exit, parentId, name, ysesBatch, collegeBatch, mentor, level, _id, id, bloodline, imageUrl}){
            ...
            <div className="containers-container">
                ...
                <div className="member-container">
                    ...
                    <div className="image-container">
                        <img src={imageUrl || memberImg} className="member-image" alt="Member" />
